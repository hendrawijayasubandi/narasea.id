...
<body>
    ...
    <section id="together-for-the-ocean"
        ...
        <div class="flex flex-col items-center mx-auto space-y-12 text-center max-w-7xl">
            <!-- Heading -->
            <h2
                class="text-white text-[24px] md:text-[48px] font-calimate font-bold leading-tight max-w-[800px] bg-raspberry-pink px-12 md:px-20 py-4 rounded-[20px] rotate-[-1.62deg]">
                Together for the Ocean
            </h2>

            <!-- Paragraph -->
            <p class="text-white text-[13px] md:text-base font-ttNorms leading-relaxed max-w-[700px] bg-blue px-5 md:px-16 py-2 rounded-[20px] rotate-[1.93deg] md:ml-[100px]"
