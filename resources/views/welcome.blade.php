...
<body>
    <!-- Hero Section -->
<section class="min-h-screen bg-blue-900/90 bg-[url('/public/assets/images/landing-page-1.png')] bg-cover bg-center flex flex-col justify-center items-start px-4 py-12 sm:px-8 sm:py-16 md:px-12 md:py-20 lg:px-24 lg:py-28 xl:px-32">
    <!-- Main Title with responsive sizing and spacing -->
    <h1 class="text-3xl font-bold mb-4 sm:text-4xl sm:mb-5 md:text-5xl md:mb-6 lg:text-6xl tracking-wide font-calimate text-white">
        See, Share, Sea.
    </h1>

    <!-- Subtitle with responsive sizing and spacing -->
    <p class="text-base max-w-md mb-8 leading-normal sm:text-lg sm:max-w-lg sm:mb-9 md:text-xl md:max-w-xl md:mb-10 lg:text-2xl lg:leading-relaxed font-ttNorms text-white">
        Through education, action, and storytelling, we empower communities to protect our seas.
    </p>

    <!-- Responsive CTA Button -->
    <button class="px-6 py-2 text-sm sm:px-7 sm:py-2.5 sm:text-base md:px-8 md:py-3 md:text-lg bg-[#FF864A] text-white rounded-full font-bold uppercase tracking-wider hover:bg-[#D96630] transition duration-200 font-ttNorms">
        Be The Change
    </button>
</section>
            ...
            <div class="stats-slider">
                ...
                <div class="px-2 h-full group">
                    <div class="flex flex-col min-h-[300px] max-h-[500px] relative overflow-hidden rounded-2xl">
                        ...
                        <div class="overflow-hidden rounded-t-2xl h-full">
                            <img src="assets/images/image-1.png" alt="Community" class="w-full h-full object-cover transition-all duration-500 ease-in-out">
                        </div>

                        <!-- Blue Section (Rises on Hover) -->
                        <div class="bg-teal-blue p-4 lg:p-6 rounded-b-2xl flex-grow flex flex-col items-start justify-end absolute bottom-0 left-0 w-full h-1/3 group-hover:h-full transition-all duration-500 ease-[cubic-bezier(0.33,1,0.68,1)] rounded-2xl group-hover:rounded-2xl">
                            <p class="text-white text-base lg:text-lg font-calimate absolute bottom-6 left-6 transition-all duration-500 ease-[cubic-bezier(0.33,1,0.68,1)] group-hover:bottom-auto group-hover:top-6 group-hover:left-6">
                                10+ coastal communities empowered.
                            </p>
                            <p class="text-white text-sm font-ttNorms opacity-0 absolute left-6 transition-all duration-500 ease-[cubic-bezier(0.33,1,0.68,1)] group-hover:opacity-100 group-hover:top-1/2 transform group-hover:-translate-y-1/2 w-[calc(100%-3rem)] leading-relaxed">
                ...
                <div class="px-2 h-full">
                    <div class="flex flex-col h-full">
                        ...
                        <div class="bg-raspberry-pink p-4 lg:p-6 rounded-b-2xl flex-grow flex items-center justify-center">
                ...
                <div class="px-2 h-full">
                    <div class="flex flex-col h-full">
                        ...
                        <div class="bg-peachy-orange p-4 lg:p-6 rounded-b-2xl flex-grow flex items-center justify-center">
                ...
                <div class="px-2 h-full">
                    <div class="flex flex-col h-full">
                        ...
                        <div class="bg-teal-blue p-4 lg:p-6 rounded-b-2xl flex-grow flex items-center justify-center">
...
<section class="relative px-4 py-16 sm:py-20 md:py-24 lg:py-28 xl:py-32 bg-blue bg-[url('/public/assets/images/ASdaf%202.png')] bg-cover bg-[position:center_30%] lg:bg-center rounded-bl-[50px] rounded-br-[50px] z-30">
    <!-- Blue overlay -->
    ...
    <div class="max-w-6xl mx-auto relative z-10">
        ...
        <div class="flex flex-col lg:flex-row gap-6 lg:gap-8">
            ...
            <div class="lg:w-1/2 w-full rounded-2xl p-4 sm:p-6">
                ...
                <button class="px-5 py-1.5 text-xs sm:text-sm md:text-base bg-peachy-orange text-white rounded-full font-bold tracking-wider hover:bg-[#D96630] transition duration-200 font-ttNorms">
                    Share What You See
                </button>
            </div>
        </div>
...
<section class="relative bg-black py-12 px-4 sm:py-16 md:py-20 lg:py-24 xl:py-32 rounded-bl-[50px] rounded-br-[50px] -mt-[50px] z-20">
    <div class="max-w-6xl mx-auto">
        <!-- Section Header -->
        <div class="mb-8 lg:mb-12 px-4 sm:px-6">
            <h1 class="text-3xl sm:text-4xl md:text-5xl font-bold text-raspberry-pink mb-2 font-calimate">Protect. Educate. Empower.</h1>
            <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-golden-yellow font-calimate">Our Projects & Partnership</h2>
        </div>
        ...
        <div class="flex flex-col lg:flex-row gap-8 lg:gap-12 px-4 sm:px-6">
            ...
            <div class="lg:w-1/3 flex flex-col justify-center">
                <p class="text-white text-sm sm:text-base md:text-lg font-ttNorms leading-relaxed">
                    At Narasea, every wave carries a story, and every initiative is a step toward protecting our marine heritage. Through collaborations with passionate organizations, we bring education, sustainability, and community empowerment to life.
                </p>
            </div>
            ...
            <div class="lg:w-2/3 relative mt-6 lg:mt-0">
                <!-- Navigation Buttons -->
                <button class="slick-prev-projects absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-teal-blue text-white rounded-full w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center hover:bg-teal-blue-dark transition -ml-4 sm:-ml-6">
                    <i class="fas fa-chevron-left text-sm sm:text-base"></i>
                </button>
            
                <button class="slick-next-projects absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-teal-blue text-white rounded-full w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center hover:bg-teal-blue-dark transition -mr-4 sm:-mr-6">
                ...
                <div class="projects-slider">
                    ...
                    <div class="px-2 h-full">
                        <div class="flex flex-col h-full rounded-2xl overflow-hidden shadow-lg bg-white/5 group">
                            <div class="aspect-[4/3] overflow-hidden relative">
                                <img src="assets/images/image-1.png" alt="Coral Triangle" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                            </div>
                            <div class="p-4 lg:p-6 flex flex-col flex-grow">
                                ...
                                <p class="text-white/80 text-xs sm:text-sm font-ttNorms flex-grow">
                                    A hero's journey into marine biodiversity conservation through education and awareness programs
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="px-2 h-full">
                        <div class="flex flex-col h-full rounded-2xl overflow-hidden shadow-lg bg-white/5 group">
                            <div class="aspect-[4/3] overflow-hidden relative">
                                <img src="assets/images/image-2.png" alt="Octopus Series" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                            </div>
                            <div class="p-4 lg:p-6 flex flex-col flex-grow">
                                <h3 class="text-white text-base sm:text-lg lg:text-xl font-bold font-calimate mb-2">
                                    Octopus Series
                    ...
                    <div class="px-2 h-full">
                        <div class="flex flex-col h-full rounded-2xl overflow-hidden shadow-lg bg-white/5 group">
                            <div class="aspect-[4/3] overflow-hidden relative">
                                <img src="assets/images/image-3.png" alt="Oceana Scar" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                            </div>
                            <div class="p-4 lg:p-6 flex flex-col flex-grow">
                                <h3 class="text-white text-base sm:text-lg lg:text-xl font-bold font-calimate mb-2">
                                    Oceana Scar
                    ...
                    <div class="px-2 h-full">
                        <div class="flex flex-col h-full rounded-2xl overflow-hidden shadow-lg bg-white/5 group">
                            <div class="aspect-[4/3] overflow-hidden relative">
                                <img src="assets/images/image-4.png" alt="Marine Cleanup" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                            </div>
                            <div class="p-4 lg:p-6 flex flex-col flex-grow">
                                <h3 class="text-white text-base sm:text-lg lg:text-xl font-bold font-calimate mb-2">
                                    Marine Cleanup
                    ...
                    <div class="px-2 h-full">
                        <div class="flex flex-col h-full rounded-2xl overflow-hidden shadow-lg bg-white/5 group">
                            <div class="aspect-[4/3] overflow-hidden relative">
                                <img src="assets/images/image-5.png" alt="Turtle Conservation" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                            </div>
                            <div class="p-4 lg:p-6 flex flex-col flex-grow">
                                <h3 class="text-white text-base sm:text-lg lg:text-xl font-bold font-calimate mb-2">
                                    Turtle Conservation
                    ...
                    <div class="px-2 h-full">
                        <div class="flex flex-col h-full rounded-2xl overflow-hidden shadow-lg bg-white/5 group">
                            <div class="aspect-[4/3] overflow-hidden relative">
                                <img src="assets/images/image-6.png" alt="Coral Restoration" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                            </div>
                            <div class="p-4 lg:p-6 flex flex-col flex-grow">
                                <h3 class="text-white text-base sm:text-lg lg:text-xl font-bold font-calimate mb-2">
                                    Coral Restoration
...
<section class="relative bg-[url('/public/assets/images/francesco-ungaro.png')] bg-cover bg-center py-16 px-4 sm:py-20 md:py-24 lg:py-28 xl:py-32 -mt-[50px] z-10">
    <!-- Teal-blue overlay with opacity -->
    <div class="absolute inset-0 bg-teal-blue/70"></div>

    <div class="max-w-6xl mx-auto relative z-10">
        <!-- Section Title -->
        <h2 class="text-3xl font-bold sm:text-4xl md:text-5xl tracking-wide font-calimate mb-8 lg:mb-12 text-center lg:text-left">
        ...
        <div class="flex flex-col lg:flex-row gap-6 lg:gap-8">
            ...
            <div class="lg:w-2/5">
                ...
                <div class="mb-6">
                    <a href="#" class="px-5 py-1.5 text-xs sm:text-sm bg-peachy-orange text-white rounded-full font-bold tracking-wider hover:bg-[#D96630] transition duration-200 font-ttNorms inline-flex items-center">
                        Follow the Waves
            ...
            <div class="lg:w-3/5">
                <div class="relative h-full flex items-center">
                    ...
                    <div class="w-full px-8 relative">
                        <!-- Navigation Buttons -->
                        <button class="slick-prev-projects absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-teal-blue text-white rounded-full w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center hover:bg-[#014951] transition -ml-8 sm:-ml-12">
                            <i class="fas fa-chevron-left text-sm sm:text-base"></i>
                        </button>

                        <button class="slick-next-projects absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-teal-blue text-white rounded-full w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center hover:bg-[#014951] transition -mr-8 sm:-mr-12">
                            <i class="fas fa-chevron-right text-sm sm:text-base"></i>
                        </button>
